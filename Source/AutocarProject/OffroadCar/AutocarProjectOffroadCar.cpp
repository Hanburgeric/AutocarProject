...
#include "AutocarProjectOffroadCar.h"
#include "AutocarProjectOffroadWheelFront.h"
#include "AutocarProjectOffroadWheelRear.h"
...
AAutocarProjectOffroadCar::AAutocarProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAutocarProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAutocarProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAutocarProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAutocarProjectOffroadWheelRear::StaticClass();
