...
#include "AutocarProjectSportsCar.h"
#include "AutocarProjectSportsWheelFront.h"
#include "AutocarProjectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AAutocarProjectSportsCar::AAutocarProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAutocarProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAutocarProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAutocarProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAutocarProjectSportsWheelRear::StaticClass();
