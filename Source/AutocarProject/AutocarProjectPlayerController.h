...
#include "AutocarProjectPlayerController.generated.h"

class UInputMappingContext;
class AAutocarProjectPawn;
class UAutocarProjectUI;
 ...
 */
UCLASS(abstract)
class AAutocarProjectPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AAutocarProjectPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="UI")
	TSubclassOf<UAutocarProjectUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UAutocarProjectUI> VehicleUI;
